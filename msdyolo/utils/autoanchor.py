...
from msdyolo.utils.general import LOGGER, colorstr, emojis
from msdyolo.utils.rboxs_utils import pi, poly2rbox, regular_theta
import cv2
...
def kmean_anchors(dataset='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Usage:
            from msdyolo.utils.autoanchor import *; _ = kmean_anchors()
    """
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from msdyolo.utils.datasets import LoadImagesAndLabels
