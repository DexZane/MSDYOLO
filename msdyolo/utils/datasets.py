...
from msdyolo.utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
from msdyolo.utils.general import (LOGGER, NUM_THREADS, check_dataset, check_requirements, check_yaml, clean_str,
                           segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywhn)
from msdyolo.utils.torch_utils import torch_distributed_zero_first
from msdyolo.utils.rboxs_utils import poly_filter, poly2rbox
...
def extract_boxes(path='../datasets/coco128'):  # from msdyolo.utils.datasets import *; extract_boxes()
...
def autosplit(path='../datasets/coco128/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from msdyolo.utils.datasets import *; autosplit()
    Arguments
...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False, profile=False, hub=False):
    ...
    Usage1: from msdyolo.utils.datasets import *; dataset_stats('coco128.yaml', autodownload=True)
    Usage2: from msdyolo.utils.datasets import *; dataset_stats('../datasets/coco128_with_yaml.zip')
    Arguments
