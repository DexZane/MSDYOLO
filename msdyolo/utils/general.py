...
from msdyolo.utils.downloads import gsutil_getsize
from msdyolo.utils.metrics import box_iou, fitness
pi = 3.141592
...
def strip_optimizer(f='best.pt', s=''):  # from msdyolo.utils.general import *; strip_optimizer()
